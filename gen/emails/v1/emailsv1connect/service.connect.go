...
package emailsv1connect

import (
	connect "connectrpc.com/connect"
	context "context"
	errors "errors"
	v1 "github.com/bufbuild/gophercon-2023-workshop/gen/emails/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	EmailServiceName = "emails.v1.EmailService"
)
...
const (
	...
	EmailServiceGetEmailProcedure = "/emails.v1.EmailService/GetEmail"
...
// UpdateEmail calls emails.v1.EmailService.UpdateEmail.
...
func (UnimplementedEmailServiceHandler) GetEmail(context.Context, *connect.Request[v1.GetEmailRequest]) (*connect.Response[v1.GetEmailResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("emails.v1.EmailService.GetEmail is not implemented"))
}
